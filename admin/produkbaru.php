                            ...
                            <div class="panel-body">
                                <div class="table-responsive no-border">
                                    <table class="table table-bordered table-striped mg-t datatable">
                                        ...
                                        <tbody>
                                        	<?php
                                            $sql1=mysql_query("SELECT * FROM frontend JOIN produk USING(KODE_PRODUK) WHERE PRODUK_BARU='ya' ORDER BY KODE_KATEGORI");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <input type="hidden" name="page" value="produkbaru.php">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                  		<div class="col-xs-10">
                            <label>Pilih produk yang akan dijadikan Produk Baru</label>
                            <input type="hidden" name="aksi" value="insert">
                            <input type="hidden" name="page" value="produkbaru.php">
                            <input type="hidden" name="produkbaru" value="ya">
