				...
				CU3ER[$(el).attr('id')] = {
					...
					*/
					initSWF: function(options) {
						...
						swfobject.embedSWF(options.vars.swf_location, $(el).attr('id'), width, height, "10.0.0", "js/expressinstall.html", options.vars, options.params, {name:$(el).attr('id'),id:$(el).attr('id')});
